...
export default function Footer() {
  return (
    <div className=" bg-slate-800 text-white mt-11">
        <footer className="footer bg-slate-800 text-white w-5/6 mx-auto p-10 ">
  <nav>
...
<footer className="footer w-5/6 mx-auto px-10 bg-slate-800 text-white py-4 border-t  border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Mehedi Hasan <br/>@copyright by mehedi hasan in 2021</p>
  </aside> 
